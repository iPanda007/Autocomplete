...
autoCompleteInputTag.addEventListener("keyup",function(e){
...
const naviGateAndSelectProduct = (key)=>{
    if( key ==="ArrowDown"){  
      ...
      resultContainer.innerHTML="";
       const showIamge = document.createElement('img')
       showIamge.src =filterProduct[indexToSelect].image
       showIamge.style.height = '100px'

       const title = document.createElement('p');
       title.append(filterProduct[indexToSelect].title)
      resultContainer.append(showIamge,title)
    } 
}
...
const selectProduct = (index)=>{
  ...
  const ProductItemContainerToSelect = document.getElementById(ProductIdToSelect)
   ProductItemContainerToSelect.style.background = "#237bff"
   ProductItemContainerToSelect.querySelector('.productName').style.color = 'white';
...
const deselectProduct = ()=>{
  ...
  productToDeselect.style.background = "white";
